    ...
    <div className="p-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-4 bg-slate-50 border-none rounded-[1.5rem] focus:ring-2 focus:ring-brand-orange/20 transition-all font-medium"
          />
        </div>
        <button
      ...
      {loading ? (
        <div className="py-20 text-center">
          <div className="animate-spin rounded-full h-10 w-10 border-t-2 border-brand-orange mx-auto mb-4"></div>
          ...
          {filteredThemes.map((theme) => (
            <div key={theme.id} className="group bg-white border border-slate-100 p-6 rounded-[2rem] hover:shadow-xl hover:shadow-slate-200/50 transition-all relative">
              <div className="flex items-start justify-between mb-4">
                <div className="p-3 bg-brand-orange-50 rounded-2xl text-brand-orange-600">
                  <LayoutGrid size={24} />
                </div>
              ...
              <code className="text-[10px] font-black text-brand-orange uppercase tracking-widest bg-brand-orange-50 px-2 py-0.5 rounded">
                {theme.slug}
              </code>
